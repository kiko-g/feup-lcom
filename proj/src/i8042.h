...
#define LEFT_ARROW_MAKE_CODE    0x1E //0x4B
#define LEFT_ARROW_BREAK_CODE   0x9E //0xCB
#define RIGHT_ARROW_MAKE_CODE   0x20 //0x4D
#define RIGHT_ARROW_BREAK_CODE  0xA0 //0xCD
